                    ...
                    <div className="container"><a className="navbar-brand" href="#">Signi<strong>App</strong></a>
                        ...
                        <div className="collapse navbar-collapse text-capitalize" id="navcol-1">
                            <ul className="nav navbar-nav ml-auto">
                                <li className="nav-item" role="presentation"><a className="nav-link active" href="#">Hướng
                                    dẫn</a></li>
                                <li className="nav-item" role="presentation"><a className="nav-link active" href="#">góp
                                    ý</a></li>
